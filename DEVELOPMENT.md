...
- @argdown/webcomponent is a webcomponent, that can toggle between map and source view. It is only a wrapper and does not generate the map or evaluates argdown sources. The developer needs to provide the svg and html, generated by an argdown application
